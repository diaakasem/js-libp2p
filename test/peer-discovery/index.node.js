...
describe('peer discovery scenarios', () => {
  ...
  it('kad-dht should discover other peers', async () => {
    ...
    libp2p.peerStore.addressBook.set(remotePeerId1, remoteLibp2p1.addressManager.announce)
    remoteLibp2p2.peerStore.addressBook.set(remotePeerId1, remoteLibp2p1.addressManager.announce)
